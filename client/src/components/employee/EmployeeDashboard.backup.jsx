                ...
                <div style={{ padding: '2rem' }}>
                  ...
                  <div style={{ marginBottom: '1.5rem', display: 'grid', gap: '1rem' }}>
                    <div>
                      ...
                      <p
                        style={{ color: '#e5e7eb', fontFamily: 'monospace', fontSize: '0.875rem' }}
                      >
                    ...
                    <div>
                      ...
                      <p
                        style={{ color: '#e5e7eb', fontSize: '0.875rem', fontFamily: 'monospace' }}
                      >
                        ...
                        <div style={{ display: 'flex', gap: '1rem' }}>
                          ...
                          >
                            <input
                              ...
                              onChange={() =>
                                setVerificationForm(prev => ({ ...prev, verified: true }))
                              }
                            />
                            Approve
                          </label>
                          ...
                          >
                            <input
                              ...
                              onChange={() =>
                                setVerificationForm(prev => ({ ...prev, verified: false }))
                              }
                            />
                            Reject
                          </label>
