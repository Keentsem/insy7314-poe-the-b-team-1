          ...
          >
            ...
            <div style={{ display: 'grid', gap: '16px' }}>
              ...
              >
                ...
                <DetailRow
                  label="Customer Name"
                  value={selectedPayment.customerName || 'N/A'}
                  highlight
                />
                <DetailRow label="Customer Email" value={selectedPayment.customerEmail} />
                <DetailRow
                  label="Customer Country"
                  value={selectedPayment.customerCountry || 'N/A'}
                />
              </div>

              <DetailRow
                label="Amount"
                value={`${selectedPayment.currency} ${selectedPayment.amount.toFixed(2)}`}
                highlight
              />
              <DetailRow label="Recipient Name" value={selectedPayment.recipientName} />
              <DetailRow
                label="Recipient Account"
                value={maskAccount(selectedPayment.recipientAccount)}
                mono
              />
              ...
              <DetailRow
                label="Status"
                value={<StatusBadge status={selectedPayment.status} size="medium" />}
              />
              <DetailRow
                label="Created At"
                value={format(new Date(selectedPayment.createdAt), 'MMM dd, yyyy HH:mm:ss')}
              />
              <DetailRow
                label="Verified By"
                value={selectedPayment.verifiedByEmail || 'N/A'}
                highlight
              />
              <DetailRow
                label="Verified At"
                value={
                  selectedPayment.verifiedAt
                    ? format(new Date(selectedPayment.verifiedAt), 'MMM dd, yyyy HH:mm:ss')
                    : 'N/A'
                }
              />
