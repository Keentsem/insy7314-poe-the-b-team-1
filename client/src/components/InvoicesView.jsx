...
const InvoicesView = () => {
  ...
  const fetchInvoices = async () => {
    try {
      const response = await fetch(API_ENDPOINTS.INVOICES_CUSTOMER, getSecureFetchOptions('GET'));
  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      >
        <h3
          style={{ color: '#e5e7eb', fontSize: '1.25rem', marginBottom: '20px', fontWeight: '600' }}
        >
          Payment History
        </h3>
        ...
        {invoices.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '3rem', color: '#9ca3af' }}>
            ...
            <p style={{ fontSize: '0.875rem', marginTop: '8px' }}>
              Invoices will appear here after employees verify your payments
            </p>
          </div>
        ) : (
          ...
          >
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div style={{ flex: 1 }}>
                  <p
                    style={{ margin: 0, color: '#e5e7eb', fontWeight: '600', fontSize: '0.875rem' }}
                  >
            ...
            <div style={{ display: 'grid', gap: '20px', marginBottom: '24px' }}>
              ...
              <div style={{ borderTop: '1px solid #374151', paddingTop: '20px' }}>
                ...
                <DetailRow
                  ...
                  value={maskAccount(selectedInvoice.recipientAccount)}
                  mono
                />
            ...
            {/* Footer */}
            <div
              style={{ borderTop: '1px solid #374151', paddingTop: '16px', textAlign: 'center' }}
            >
